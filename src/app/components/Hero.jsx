                ...
                <div className="hero-content text-center">
                    <div className="lg:max-w-[70%]">
                        <div className="mx-5 py-10 bg-white/50">
                            ...
                            <p className="my-5 font-medium text-2xl">Ya la vida nos dirá qué depara el camino, lo que sí es que yo por mi parte lo que más odio es arrepentirme de no hacer algo, y desde hace un tiempo me dije que no quería dejarte pasar sin más, así que dentro de mi egoísmo también intentaré lo que pueda en ese aspecto, al final solo quería decírtelo de alguna manera.</p>

                            <p className="my-5 font-medium text-2xl">Bueno, y por último y más importante, más allá de pensamientos de qué es lo mejor o no para cada uno, mi interés por tu bienestar es genuino y aunque pasen las cosas que pasen, mientras siga yo por acá, en la medida de lo posible me gustaría ayudarte (no soy Superman jajaja ni mucho menos un salvador), pero al menos quisiera transmitirte que la soledad no es absoluta.</p>

                            <p className="my-5 font-medium text-2xl">En fin, creo que eso sería todo de momento, corazón de melocotón.</p>

                            <p className="my-5 font-medium text-2xl">Realmente te quiero mucho.</p>
